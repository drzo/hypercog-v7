...
export async function setupGitHubRepo(env: Env): Promise<void> {
...
function getWorkflowContent(cycleNumber: number): string {
...
function getAnalysisWorkflowContent(): string {
