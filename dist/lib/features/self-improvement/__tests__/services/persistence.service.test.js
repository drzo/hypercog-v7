...
describe('PersistenceService', () => {
    ...
    describe('State Management', () => {
        it('should save state', async () => {
            ...
            expect(storage.save).toHaveBeenCalledWith('state_history', expect.arrayContaining([mockState]));
        });
        it('should limit state history to 100 entries', async () => {
            ...
            expect(storage.save).toHaveBeenCalledWith('state_history', expect.arrayContaining([newState]));
    ...
    describe('Note Management', () => {
        it('should save note', async () => {
            ...
            expect(storage.save).toHaveBeenCalledWith('notes', expect.arrayContaining([mockNote]));
        });
