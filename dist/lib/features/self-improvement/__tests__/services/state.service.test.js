...
describe('StateService', () => {
    ...
    it('should handle errors when getting current state', async () => {
        ...
        expect(loggerService.error).toHaveBeenCalledWith('Failed to get current state', error);
    });
    ...
    it('should handle errors when getting previous state', async () => {
        ...
        expect(loggerService.error).toHaveBeenCalledWith('Failed to get previous state', error);
    });
});
